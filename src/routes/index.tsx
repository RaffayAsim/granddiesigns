...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Brand & Digital Studio — Logo Design, Web Dev, Marketing & AI Automation" },
      { name: "description", content: "End-to-end digital studio: custom logo design, high-converting website development, digital marketing, and intelligent AI automation." },
      { property: "og:title", content: "Brand & Digital Studio — Logo Design, Web Dev, Marketing & AI Automation" },
      { property: "og:description", content: "Custom logo design, website development, digital marketing campaigns, and AI workflow automation." },
