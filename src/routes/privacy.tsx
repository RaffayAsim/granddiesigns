...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — Grand Designs" },
      { name: "description", content: "Understanding how Grand Designs protects your personal data, intellectual property, project briefs, and proprietary technology." },
      { property: "og:title", content: "Privacy Policy — Grand Designs" },
      { property: "og:description", content: "Understanding how Grand Designs protects your personal data, intellectual property, project briefs, and proprietary technology." },
    ],
  }),
});
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-24 bg-[#0c2340] text-white border-b border-[#00b4d8]/30 overflow-hidden select-none">
        ...
        <div className="relative w-full max-w-[1800px] mx-auto px-6 md:px-16 lg:px-24 z-10 space-y-6">
          ...
          <p className="text-slate-300 font-sans text-lg md:text-2xl font-light leading-relaxed max-w-4xl">
            Grand Designs · Privacy &amp; Data Security Policy
          </p>
        </div>
      </section>
